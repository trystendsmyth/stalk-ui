...
const componentDescriptions = {
  ...
  carousel: 'Cycles through slides of content with prev/next controls.',
  chart: 'A theming contract for charts; bring your own recharts.',
  ...
  drawer: 'Slides a Vaul-backed bottom sheet up from the screen edge with drag-to-dismiss.',
