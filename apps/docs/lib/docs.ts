...
export const componentGroups = [
  ...
  {
    title: 'Date & Time',
    slugs: ['calendar', 'date-picker', 'datetime-input', 'time-picker'],
  },
  {
    title: 'Forms & Buttons',
    slugs: ['button', 'copy-button', 'file-upload', 'form', 'label'],
  },
  {
    title: 'Tables & Lists',
    slugs: [
  ...
  },
  {
    ...
    slugs: ['chart', 'sparkline', 'heatmap', 'qr-code'],
  },
  {
    title: 'Display',
    slugs: ['avatar', 'badge', 'card', 'tag', 'stat', 'timeline', 'empty-state', 'swap'],
  },
  {
    title: 'Navigation',
    slugs: ['breadcrumb', 'navigation-menu', 'pagination', 'sidebar', 'steps', 'tabs', 'toolbar'],
  },
  {
    title: 'Menus',
    slugs: ['command', 'context-menu', 'dropdown-menu', 'menubar'],
  },
  {
    title: 'Overlay',
    slugs: [
